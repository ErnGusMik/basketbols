...
function App() {
  const router = createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          errorElement: (
            <div>An error occured / Notika kļūda (TOURNAMENT-FATAL)</div>
          ),
        },
        {
          path: "/app/game/:id",
          ...
          errorElement: (
            <div>An error occured / Notika kļūda (GAME_ADMIN-FATAL)</div>
          ),
        },
        {
    ...
    },
    {
      ...
      element: <Email />,
      errorElement: (
        <div>An error occured / Notika kļūda (LOGIN_EMAIL-FATAL)</div>
      ),
    },
    {
      path: "/signup",
