    ...
    <div className="login">
      ...
      <div className="sideContainer">
        <div className="loginContainer">
          ...
          <Link to="/login/email">
            <button className="loginButton">
              <img src="data:image/png;base64," className="buttonImage"/>
              <p>Ienākt ar e-pastu</p>
            </button>
          </Link>
        </div>
        <p className="noAccount">Nav konta? Reģistrējies <Link to="/signup">šeit</Link>.</p>
