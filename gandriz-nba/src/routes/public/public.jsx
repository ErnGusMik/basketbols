...
export default function PublicPage() {
  ...
  return (
    <div className="publicPage__cont">
      <i className="fa-solid fa-globe changeLang" onClick={changeLanguage}></i>
      <div className="loadingOverlay">
        <img src={basketballImg} alt="Basketball image" />
        <svg width={300} height={3}>
          <rect width={300} height={3} style={{ fill: "rgb(0,0,0)" }} />
        </svg>
      </div>
      <div className="banner">
        <h1>
          {tournament ? tournament.name : lang ? "Loading..." : "Lādējās..."}
        </h1>
      </div>
      <div className="row">
        ...
        <div className="jump__cont element">
          ...
          <ul>
            ...
            <li>
              <a href="#stats">{lang ? "Statistics" : "Statistika"}</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="row" id="now">
          ...
          >
            ...
            <div className="gameData__cont">
              ...
              <div className="gameData">
                ...
                <p>
                  {new Date(now.previous.time).toLocaleDateString("en-GB", {
                    year: "2-digit",
                    month: "2-digit",
                    day: "2-digit",
                  })}
                ...
                <p>
                  {new Date(now.previous.time).toLocaleTimeString("en-GB", {
                    hour: "2-digit",
                    minute: "2-digit",
                  })}
                </p>
          ...
          >
            ...
            <div className="gameData__cont">
              ...
              <div className="gameData">
                ...
                <p>
                  {new Date(now.current.time).toLocaleDateString("en-GB", {
                    year: "2-digit",
                    month: "2-digit",
                    day: "2-digit",
                  })}
                ...
                <p>
                  {new Date(now.current.time).toLocaleTimeString("en-GB", {
                    hour: "2-digit",
                    minute: "2-digit",
                  })}
                </p>
        ...
        {now.next && (
          <Link
            ...
            to={
              now.next.ongoing ? "/game/" + now.next.public_id + "/watch" : "#"
            }
          >
            <div className="teams">
              <div className="team">
            ...
            <div className="gameData__cont">
              ...
              <div className="gameData">
                ...
                <p>
                  {new Date(now.next.time).toLocaleDateString("en-GB", {
                    year: "2-digit",
                    month: "2-digit",
                    day: "2-digit",
                  })}
                ...
                <p>
                  {new Date(now.next.time).toLocaleTimeString("en-GB", {
                    hour: "2-digit",
                    minute: "2-digit",
                  })}
                </p>
        ...
        {games.map((group, index) => {
          ...
          return (
            <div>
              ...
              >
                <b>{alphabet[index]}</b> {lang ? "group" : "grupa"}
              </p>
              <Table
                pubTable
                cols={[
                ...
                content={group.map((game) => {
                  ...
                  return [
                    ...
                    refs
                      ...
                      .join(", "),
                    game.public_id ? (
                      <Link to={"/game/" + game.public_id + "/watch"}>
                        {lang ? "watch" : "skatīt"}
                      </Link>
                    ) : (
                      ""
        ...
        {teams.map((group, index) => {
          ...
          return (
            <div className="groupTable">
              ...
              >
                <b>{group[0].teamgroup}</b> {lang ? "group" : "grupa"}
              </p>
              <Table
                pubTable
                cols={[
      ...
      <div className="stats" id="stats">
        ...
        <div className="statCard">
          <h2>{lang ? "Successful 3pt shots" : "Veiksmīgi 3p metieni"}</h2>
          <div className="listContainer">
            <ol>
        ...
        <div className="statCard">
          <h2>{lang ? "Best scorers" : "Rezultatīvākie spēlētāji"}</h2>
          <div className="listContainer">
            <ol>
        ...
        <div className="statCard">
          <h2>{lang ? "Points scored against" : "Ielaistie punkti"}</h2>
          <div className="listContainer">
            <ol>
      ...
      <div className="playersOverlay" id="playersOverlay">
        <div className="playersOverlayData">
          <img src={basketballImg} alt="Basketball" className="absoluteDecor" />
            ...
            {tempPlayers.players.map((player, index) => {
              return (
                <div className="playerCard" key={index}>
                  <h2>{player.number}</h2>
                  <p>
                    {lang ? "Points" : "Punkti"}: <b>{player.points}</b>
                  </p>
                  <p>
                    {lang ? "Blocks" : "Bloki"}: <b>{player.blocks}</b>
                  </p>
                  <h3>
                    {player.firstname}{" "}
                    <span className="uppercase">{player.lastname}</span>
                  </h3>
