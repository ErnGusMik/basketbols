    ...
    return (
        <div className="publicPage__cont">
            ...
            <div className="row">
                <div className="desc__cont element">
                    <p>
                        ...
                        elit. Optio, odio delectus, blanditiis corrupti hic
                        rerum vel explicabo natus distinctio ratione
                        voluptatibus aperiam quia minus, fuga cum dolores
            ...
            <footer>
                ...
                <p>Izveidots izmantojot <a href="#">Gandrīz NBA</a></p>
            </footer>
        </div>
    );
}
