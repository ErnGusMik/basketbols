...
export default function PublicPage() {
  ...
  const getData = async () => {
    ...
    const tournamentIDreq = await fetch(
      "http://localhost:8080/api/tournaments/getIDfromName?name=" + params["*"],
    );
    ...
    const gamereq = await fetch(
      "http://localhost:8080/api/tournaments/" + tournamentID.id + "/games",
    );
    ...
    const refreq = await fetch(
      "http://localhost:8080/api/tournaments/" + tournamentID.id + "/referees",
      {
        method: "GET",
        headers: {
    ...
    const teamreq = await fetch(
      "http://localhost:8080/api/tournaments/" + tournamentID.id + "/teams",
    );
  ...
  const setNowGames = async () => {
    ...
    const ongoingGames = await fetch("http://localhost:8080/api/games/live", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
