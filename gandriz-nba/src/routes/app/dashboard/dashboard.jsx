    ...
    return (
        <div className="dashboard">
            ...
            <div className="component">
                ...
                <div className="tournamentData">
                    ...
                    <div className="infoRow">
                        <i className="fa-solid fa-location-dot" style={{fontWeight: 600}}></i>
                        <p>Ogre</p>
                    </div>
                    <div className="infoRow">
            ...
            <Link to="/app/new-tournament">
                <Button text="Jauns turnīrs" icon={<i className="fa-solid fa-plus" style={{fontWeight: 300, marginRight: '5px'}}></i>} />
            </Link>
        </div>
    );
};
