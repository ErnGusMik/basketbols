...
export default function NewTournament3() {
    ...
    return (
        <div className="new-tournament-3__container">
            <div className="new-tournament-3">
                <div className="flexCont">
                    ...
                    <div className="table__container">
                        ...
                        content={[]}
                        />
                        <p>Izvēlies kuri tiesneši drīkstēs tiesāt izslēgšanas spēles.<br />Ja neizvēlēsies nevienu, tie tiks automātiski salikti.</p>
                    </div>
                </div>
            ...
            <div className="overlay" id="newTournament3Overlay">
            </div>
