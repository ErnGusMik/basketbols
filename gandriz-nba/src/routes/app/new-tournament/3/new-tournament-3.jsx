...
export default function NewTournament3() {
    ...
    const getData = () => {
        ...
        if (tournamentLogo && !tournamentLogo === 'data:application/octet-stream;base64,') {
    ...
    const submitReferee = (e) => {
        ...
        if (savedData) {
            ...
            localStorage.setItem('referees', JSON.stringify([[refereeName, refereePlayoffs]]))
        }
    ...
    const setTable = () => {
        ...
        savedData.forEach(referee => {
            output.push([
                referee[0],
                referee[1] ? <span className="refereeOuter"><span className="refereeInner"></span></span> : <span className="refereeOuter"></span>
            ])
        })
        return output
    }
    ...
    return (
        <div className="new-tournament-3__container">
                ...
                <div className="flexCont">
                    ...
                    <div className="table__container">
                        <Table
                            ...
                            setColWidth='300px'
                            content={JSON.parse(localStorage.getItem('referees')) ? setTable('') : []}
                        />
                        <p>Izvēlies kuri tiesneši drīkstēs tiesāt izslēgšanas spēles.<br /><br />Ja neizvēlēsies nevienu, tie tiks automātiski salikti.</p>
                    </div>
                </div>
                <div className="tournamentInfo__container">
                    <div className="tournamentInfo">
                        ...
                        <div>
                            ...
                            <p>
                                {data.groupNum ? data.groupNum : '0'} grupas, {data.teamNum ? data.teamNum : '0'} komandas
                            </p>
            ...
            <div className="addTeam" id="addReferee">
                <form className="addTeamForm" id="addRefereeForm" onSubmit={submitReferee}>
