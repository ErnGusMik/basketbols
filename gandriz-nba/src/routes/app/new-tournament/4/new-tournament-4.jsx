      ...
      group.forEach((game) => {
        readySchedule.push([
          ...
          <input
            ...
            defaultValue={game.date.toLocaleDateString("en-GB", dateOptions)}
          />,
          <input
            className="invisibleInput"
            defaultValue={game.time.toLocaleTimeString("en-GB", timeOptions)}
          />,
          game.referees,
    ...
    for (let j = 0; j < container.children.length; j++) {
      ...
      for (let i = 0; i < tableRows.length; i++) {
        ...
        try {
          ...
          document.getElementById("tableError-" + groups[j]).innerHTML =
