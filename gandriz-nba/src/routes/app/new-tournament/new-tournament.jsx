        ...
        for (let i = 0; i < groupNums.length; i++) {
            for (let j = 0; j < allowed.length; j++) {
                if (groupNums[i] === allowed[j]) {
                    ...
                    teamsInGroup.push(
                        teamNum / allowed[j] + (lang ? " teams" : " kom.")
                    );
                }
            }
        }
            ...
            <form onSubmit={handleSubmit} className="new-tournament-1">
                <div className="horizontalCont">
                    <div className="flexCol">
                        <TextInput
                            label={
                                lang ? "Tournament name" : "Turnīra nosaukums"
                            }
                            placeholder={
                                lang
                                    ? "School tournament " +
                        ...
                        <TextInput
                            label={
                                lang
                                    ...
                                    : "Turnīra organizators(i)"
                            }
                            placeholder={
                                lang
                                    ? "Riga state gymnasium No3"
                                    : "Ogres 1. vidusskola"
                            }
                            inputID="organizer"
                            required={true}
                        ...
                        <TextInput
                            label={
                                lang ? "Tournament location" : "Norises vieta"
                            }
                    ...
                    <div className="flexCol">
                        ...
                        <div className="submitContainer">
                            <div>
                                <p>
                                    {lang
                                        ? "Every team will contain"
                                        : "Katrā grupā spēlēs"}{" "}
                                    <b>
                                        {teamNum && selectedGroup
                                            ? teamNum / selectedGroup
                                            : 0}
                                    </b>{" "}
                                    {lang ? "teams" : "komandas"}.
