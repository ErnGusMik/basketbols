...
export default function Analysis() {
  ...
  document.title = `${teamData.team1 ? teamData.team1 : "Lādējas..."} VS ${teamData.team2 ? teamData.team2 : "Lādējas..."} | Spēles analīze | Gandrīz NBA`;
    ...
    <div className="analysis__cont">
      ...
      <div className="statRow">
        <h4 className="statVal">
          {gameData.team1biggestlead ? gameData.team1biggestlead : "0"}p
        </h4>
        <p className="statLabel">Lielākais pārsvars</p>
        <h4 className="statVal">
          {gameData.team2biggestlead ? gameData.team2biggestlead : "0"}p
        </h4>
      </div>
      <div className="statRow">
        <h4 className="statVal">
          {gameData.team13points
            ? Math.floor((gameData.team13points / gameData.team1points) * 100)
            : "0"}
          %
        </h4>
        ...
        <h4 className="statVal">
          {gameData.team23points
            ? Math.floor((gameData.team23points / gameData.team2points) * 100)
            : "0"}
          %
        </h4>
      </div>
      <div className="statRow">
        <h4 className="statVal">
          {gameData.team12points
            ? Math.floor((gameData.team12points / gameData.team1points) * 100)
            : "0"}
          %
        </h4>
        ...
        <h4 className="statVal">
          {gameData.team22points
            ? Math.floor((gameData.team22points / gameData.team2points) * 100)
            : "0"}
          %
        </h4>
      </div>
      <div className="statRow">
        <h4 className="statVal">
          {gameData.team1mostpointsinrow ? gameData.team1mostpointsinrow : "0"}p
        </h4>
        <p className="statLabel">Garākais izrāviens</p>
        <h4 className="statVal">
          {gameData.team2mostpointsinrow ? gameData.team2mostpointsinrow : "0"}p
        </h4>
      </div>
      <div className="statRow">
        <h4 className="statVal">
