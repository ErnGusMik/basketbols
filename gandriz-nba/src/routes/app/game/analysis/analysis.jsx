  ...
  return (
    <div className="analysis__cont">
      ...
      <div className="statRow">
        ...
        <p className="statLabel">
          {lang ? "Biggest lead" : "Lielākais pārsvars"}
        </p>
        <h4 className="statVal">
      ...
      <div className="statRow">
        ...
        <p className="statLabel">
          {lang ? "3pt % of all points" : "3p % no visiem metieniem"}
        </p>
        <h4 className="statVal">
      ...
      <div className="statRow">
        ...
        <p className="statLabel">
          {lang ? "2pt % of all points" : "2p % no visiem metieniem"}
        </p>
        <h4 className="statVal">
          {gameData.team22points
            ? Math.floor(
      ...
      <div className="statRow">
        ...
        <p className="statLabel">
          {lang ? "Most points in row" : "Garākais izrāviens"}
        </p>
        <h4 className="statVal">
