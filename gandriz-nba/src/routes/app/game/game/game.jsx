...
export default function Game() {
      ...
      if (response.paused) {
        ...
        setInstructions(
          <p>
            ...
            {lang ? "foul" : "piezīme"}, <i className="fa-solid fa-shield" /> -{" "}
            {lang ? "block" : "bloks"},{" "}
  ...
  React.useEffect(() => {
    ...
    if (data.team1Points !== gameData.team1points) {
      ...
      setTimeout(() => {
        document.getElementById("team1points").classList.remove("active");
      }, 1500);
    ...
    if (data.team2Points !== gameData.team2points) {
      ...
      setTimeout(() => {
        document.getElementById("team2points").classList.remove("active");
      }, 1500);
    ...
    if (timeoutTime < 11) {
      setInstructions(
        <p>
          ...
          {lang ? "Timeout (1 min):" : "Minūtes pārtraukums:"} {timeoutTime}{" "}
    ...
    if (start === false && time >= 6000) {
      ...
      setInstructions(
        <p>
          ...
          <i className="fa-solid fa-hourglass-start" /> - 1min pārtraukums.
        </p>,
      );
  ...
  React.useEffect(() => {
    if (time === 0) {
      ...
      if (quarter === 1 || quarter === 3) {
        setInstructions(
          <p>
            Pārtraukums pirms {quarter + 1}. ceturtdaļas. Spēle jāturpina pēc 2
            min. (
        ...
        setInstructions(
          <p>
            ...
            <i className="fa-solid fa-arrow-right" /> vai atsarpes taustiņu.
          </p>,
        );
    ...
    <div className="game__container">
      ...
      <div className="gameFlex__container">
        <div className="flexCont team">
          ...
          >
            <span className={fouls.team1 >= 1 ? "foul active" : "foul"} />
            <span className={fouls.team1 >= 2 ? "foul active" : "foul"} />
            <span className={fouls.team1 >= 3 ? "foul active" : "foul"} />
            <span className={fouls.team1 >= 4 ? "foul active" : "foul"} />
            <span className={fouls.team1 >= 5 ? "foul active" : "foul"} />
          </div>
          <div className="btnCont">
            <KeyboardBtn
              pointer
        ...
        <div className="flexCont team team-right">
          ...
          >
            <span className={fouls.team2 >= 1 ? "foul active" : "foul"} />
            <span className={fouls.team2 >= 2 ? "foul active" : "foul"} />
            <span className={fouls.team2 >= 3 ? "foul active" : "foul"} />
            <span className={fouls.team2 >= 4 ? "foul active" : "foul"} />
            <span className={fouls.team2 >= 5 ? "foul active" : "foul"} />
          </div>
          <div className="btnCont">
            <KeyboardBtn
              pointer
      ...
      <div
        ...
        style={windowWidth < 715 ? { display: "flex" } : { display: "none" }}
      >
        ...
        <p>
          Ekrāni šaurāki par 715px netiek atbalstīti. (jums {windowWidth}px)
        </p>
      </div>
    </div>
  );
