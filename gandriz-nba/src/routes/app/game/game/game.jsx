    ...
    <div className="game__container">
      <div className="gameFlex__container">
        <div className="flexCont team">
          ...
          <div className="btnCont">
            <KeyboardBtn text={<i class="fa-solid fa-circle-xmark"></i>} />
            <KeyboardBtn text={<i class="fa-solid fa-shield"></i>} />
            <KeyboardBtn text={<i class="fa-solid fa-hourglass-start"></i>} />
          </div>
        </div>
        <div className="flexCont team">
          <h2>Ogres SC</h2>
