    ...
    <div className="watch__cont">
      ...
      <div className="backgOverlay">
        ...
        <p className="topBarText">
          #{lang ? "Support" : "Atbalsti"}
          <span className="bold">{lang ? "your" : "Savējos"}</span>
          {lang ? "team" : ""}
        </p>
        ...
        <div className="largeInfoCont">
          <div className="timeCont">
            ...
            <p>
              <b>
                {lang ? "Period" : "Periods"} {gameData.period}
              </b>
            </p>
        ...
        <div
          ...
          onClick={(e) => {
            document.querySelector(".foulOverlay").style.display = "none";
          }}
        >
          <div
            ...
            {foulOverlayData.players.map((player) => {
              return (
                <div className="playerFouls">
                  ...
                  >
                    <span
                      className={player.fouls >= 1 ? "foul active" : "foul"}
                    ></span>
                    <span
                      className={player.fouls >= 2 ? "foul active" : "foul"}
                    ></span>
                    <span
                      className={player.fouls >= 3 ? "foul active" : "foul"}
                    ></span>
                    <span
                      className={player.fouls >= 4 ? "foul active" : "foul"}
                    ></span>
                    <span
                      className={player.fouls >= 5 ? "foul active" : "foul"}
                    ></span>
                  </div>
                </div>
              );
